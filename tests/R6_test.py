...
class TestR6():
    ...
    def test_case_sensitive_title(self, mocker):
        ...
        mocker.patch('services.library_service.get_books_by_title', return_value=[{'author': 'F. Scott Fitzgerald', 'available_copies': 3, 'id': 1, 'isbn': '9780743273565', 'title': 'The Great Gatsby', 'total_copies': 3}])
    ...
    def test_search_w_isbn(self, mocker):
        mocker.patch('services.library_service.get_book_by_isbn', return_value=[{'author': 'F. Scott Fitzgerald', 'available_copies': 3, 'id': 1, 'isbn': '9780743273565', 'title': 'The Great Gatsby', 'total_copies': 3}])

        msg = library_service.search_books_in_catalog("9780743273565", "isbn")
        assert any(book['title'] == "The Great Gatsby" for book in msg)

    def test_search_w_author(self, mocker):
        mocker.patch('services.library_service.get_books_by_author', return_value=[{'author': 'F. Scott Fitzgerald', 'available_copies': 3, 'id': 1, 'isbn': '9780743273565', 'title': 'The Great Gatsby', 'total_copies': 3}])
